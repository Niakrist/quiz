  ...
  return (
    <>
      <div className={s.question}>
        <img className={s.img} src={flagSrc} alt="Флаг" />
        <h2 className={s.title}>Флаг какой страны изображен?</h2>
      ...
      <ul className={s.flagList}>
        <li className={s.flagItem}>
          <button className={s.flagBtn}>
            <span className={s.num}>1</span>{" "}
            <span className={s.answer}>Камерун</span>
          </button>
        </li>
        <li className={s.flagItem}>
          <button className={s.flagBtn}>
            <span className={s.num}>2</span>{" "}
            <span className={s.answer}>Нигерия</span>
          </button>
        </li>
        <li className={s.flagItem}>
          <button className={s.flagBtn}>
            <span className={s.num}>3</span>{" "}
            <span className={s.answer}>Центрально-Африканская Республика</span>
          </button>
        </li>
        <li className={s.flagItem}>
          <button className={s.flagBtn}>
            <span className={s.num}>4</span>{" "}
            <span className={s.answer}>Гаити</span>
          </button>
        </li>
      </ul>
      <div className={s.wrapper}>
        <Button disabled={true}>Ответить</Button>
        <span className={s.score}>1 / 18</span>
      </div>
    </>
  );
};
