...
- контекст QuizContext переполнен большим количеством зависимостей и было бы неплохо его декомпозировать по принципу ответственностей ---===---: Согласен, но пока не придумал как это теперь все разъединить и что бы все не развалилось, всё слишком зависит друг от друга(
